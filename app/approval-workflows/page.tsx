    ...
    <PlatformLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-[13px] font-semibold text-gray-900 dark:text-gray-100">Approval Workflows</h1>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] text-gray-600 dark:text-gray-400">Active Workflows</p>
                  <p className="text-[13px] font-semibold text-gray-900 dark:text-gray-100">8</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] text-gray-600 dark:text-gray-400">Avg Completion Rate</p>
                  <p className="text-[13px] font-semibold text-gray-900 dark:text-gray-100">94.8%</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] text-gray-600 dark:text-gray-400">Avg Processing Time</p>
                  <p className="text-[13px] font-semibold text-gray-900 dark:text-gray-100">1.8 days</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] text-gray-600 dark:text-gray-400">Pending Approvals</p>
                  <p className="text-[13px] font-semibold text-gray-900 dark:text-gray-100">23</p>
                </div>
              </div>
            </CardContent>
          </Card>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <h3 className="font-medium text-[11px] text-gray-900 dark:text-gray-100">{workflow.name}</h3>
                        <Badge variant="outline">{workflow.department}</Badge>
                      </div>
                      <p className="text-[10px] text-gray-600 dark:text-gray-400">{workflow.description}</p>
