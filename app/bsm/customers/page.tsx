          ...
          <Table>
            ...
            <TableBody>
              {filteredAccounts.map((account) => {
                const accountAvatarProps = getAvatarProps(account.name)
                const ownerAvatarProps = getAvatarProps(account.owner.name)
                    ...
                    <TableCell>
                      <div className="flex items-center gap-3">
                        <Avatar className="h-6 w-6">
                          ...
                          <AvatarFallback
                            className={`text-xs ${accountAvatarProps.colorClass} text-white font-semibold`}
                          >
                            {accountAvatarProps.initials}
                          </AvatarFallback>
                        </Avatar>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <Avatar className="h-6 w-6">
                          ...
                          <AvatarFallback className={`text-xs ${ownerAvatarProps.colorClass} text-white font-semibold`}>
                            {ownerAvatarProps.initials}
                          </AvatarFallback>
                        </Avatar>
