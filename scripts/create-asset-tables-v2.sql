...
INSERT INTO public.assets (name, category, hostname, ip_address, operating_system, status, criticality, location, notes) VALUES
    ('Web Server 01', 'server', 'web01.company.com', '192.168.1.10', 'Ubuntu 22.04 LTS', 'active', 'critical', 'Data Center A', 'Primary web server'),
    ('Database Server', 'server', 'db01.company.com', '192.168.1.11', 'CentOS 8', 'active', 'critical', 'Data Center A', 'Main database server'),
    ('John Laptop', 'laptop', 'john-laptop', '192.168.1.100', 'Windows 11', 'active', 'medium', 'Office Floor 2', 'Development laptop'),
    ('Conference Room PC', 'workstation', 'conf-room-01', '192.168.1.50', 'Windows 10', 'active', 'low', 'Conference Room A', 'Presentation computer'),
    ('Network Switch', 'network', 'switch-01', '192.168.1.1', 'Cisco IOS', 'active', 'high', 'Network Closet', 'Main network switch');
